...
__all__ = [
    'DISPID_SRGCmdLoadFromObject', 'SPVOICESTATUS', 'SVF_Stressed',
    'DISPID_SASetState', 'SVP_14', 'eLEXTYPE_PRIVATE8',
    'SpeechVisemeType', 'SpeechFormatType', 'SPWF_SRENGINE',
    ...
    'ISpEventSink', 'ISpeechVoiceStatus', 'ISpeechVoice',
    'SPTEXTSELECTIONINFO', 'ISpeechAudio',
    'DISPID_SRGetPropertyNumber', 'ISpRecoContext', 'ISpStream',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGCommit',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFT12kHz8BitStereo', 'SGDisplay',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SSFMCreate',
    'DISPID_SVStatus', 'DISPID_SVAlertBoundary',
    'SAFTADPCM_44kHzMono', 'DISPID_SPIReplacements', 'SDTAll',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_1', 'DISPID_SPPName',
    'SPPARTOFSPEECH', 'SPLO_STATIC', 'DISPID_SGRAddResource',
    'SAFT8kHz8BitMono', 'DISPID_SOTDataKey', 'SASRun',
    'DISPID_SRCEAudioLevel', 'SPFM_CREATE_ALWAYS', 'SRATopLevel',
    'SpeechAudioVolume', 'SRCS_Disabled', 'SREAudioLevel',
    'SPPS_Verb', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SLGetPronunciations', 'DISPID_SPERequiredConfidence',
    'SP_VISEME_0', 'SpeechTokenKeyUI', 'tagSTATSTG',
    'SAFT12kHz8BitMono', 'SpeechVoicePriority',
    'DISPID_SVSRunningState', 'SAFT12kHz16BitStereo',
    'ISpeechAudioFormat', 'DISPID_SRRRecoContext', 'DISPID_SPEsItem',
    'SREAllEvents', 'SpeechInterference', 'SpeechGrammarTagDictation',
    'DISPID_SASState', 'SDTDisplayText', 'SPSEMANTICERRORINFO',
    'ISpeechRecognizerStatus', 'DISPID_SpeechPhraseElements',
    'SP_VISEME_11', 'SPRECOSTATE', 'SDTPronunciation', 'SASStop',
    'SPEI_ADAPTATION', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechGrammarRuleStateTransition', 'SREAdaptation',
    'SpeechRetainedAudioOptions', 'DISPID_SPILanguageId',
    'SPSERIALIZEDRESULT', 'SPSInterjection', 'eLEXTYPE_RESERVED9',
    'SpInProcRecoContext', 'SAFTCCITT_uLaw_22kHzStereo', 'SRAONone',
    'DISPID_SpeechAudioStatus', 'DISPID_SRRecognizer',
    'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPEAudioStreamOffset', 'tagSPPROPERTYINFO',
    'SAFT32kHz16BitStereo', 'SAFTADPCM_11kHzStereo',
    'SGDSActiveWithAutoPause', 'SpeechVoiceEvents',
    'DISPID_SGRSTPropertyValue', 'DISPID_SBSSeek', 'DISPID_SFSClose',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPIGrammarId',
    'DISPID_SpeechVoice', 'DISPID_SRCVoice', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVAudioOutput', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPRuleId', 'ISpeechTextSelectionInformation',
    'SpeechAudioFormatGUIDWave', 'SPEVENTSOURCEINFO',
    'DISPID_SVAudioOutputStream', 'SpeechCategoryRecognizers',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechObjectToken',
    'DISPID_SLPPhoneIds', 'ISpeechRecoResult', 'DISPID_SPIRule',
    'DISPID_SpeechPhraseBuilder', 'SDTReplacement',
    'SpeechLoadOption', 'DISPID_SDKGetlongValue',
    'DISPID_SVDisplayUI', 'SPRECOGNIZERSTATUS',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRCERequestUI',
    'SAFTADPCM_44kHzStereo', 'SpUnCompressedLexicon', 'SGSDisabled',
    'SPPS_Noun', 'SpeechRegistryUserRoot',
    'DISPID_SREmulateRecognition', 'SWPKnownWordPronounceable',
    'SVSFNLPSpeakPunc', 'SDTProperty', 'DISPID_SMSAMMHandle',
    'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE6', 'SECFIgnoreWidth',
    'ISpRecognizer2', 'DISPID_SGRSTWeight', 'DISPID_SBSWrite',
    'DISPID_SRGState', 'ISpeechPhraseProperty',
    'DISPID_SRCEPropertyNumberChange', 'SPAS_PAUSE',
    'ISpeechObjectToken', 'DISPID_SGRsDynamic', 'SAFT24kHz8BitStereo',
    'SPEI_HYPOTHESIS', 'SAFT48kHz16BitMono', 'DISPID_SRRAlternates',
    'DISPID_SLPType', 'SRTExtendableParse',
    'DISPID_SDKSetBinaryValue', 'DISPID_SOTs_NewEnum',
    'SAFTCCITT_ALaw_11kHzStereo', 'SGRSTTRule', 'SWTDeleted',
    'DISPID_SPRulesCount', 'eLEXTYPE_PRIVATE7', 'SPFILEMODE',
    'DISPID_SPIGetText', 'DISPID_SVSInputWordPosition',
    'ISpRecoGrammar2', 'DISPID_SOTIsUISupported',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCEInterference',
    'DISPID_SVSkip', 'DISPID_SpeechFileStream', 'ISpeechDataKey',
    'DISPID_SPEAudioSizeTime', 'SPPHRASEPROPERTY', 'SPRS_INACTIVE',
    'DISPID_SPPsCount', 'SpShortcut', 'DISPID_SPPParent',
    'IEnumSpObjectTokens', 'DISPID_SLPs_NewEnum', 'DISPID_SAFGuid',
    'SPINTERFERENCE_TOOLOUD', 'SPADAPTATIONRELEVANCE',
    'DISPID_SPAPhraseInfo', 'SpeechEngineConfidence', 'SVEViseme',
    'DISPID_SPIElements', 'SAFT22kHz16BitMono', 'SPCS_ENABLED',
    'SPWORD', 'SRCS_Enabled', 'SPCT_SUB_DICTATION',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE5',
    'SpeechPartOfSpeech', 'DISPID_SRAudioInputStream',
    'DISPID_SBSFormat', 'SAFT11kHz16BitMono', 'ISpRecoCategory',
    'DISPID_SPEDisplayAttributes', 'SSTTWildcard',
    'SPDKL_CurrentUser', 'ISpNotifySource',
    'DISPID_SRCEventInterests', 'SRTStandard',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRGetXMLResult',
    'SVSFPersistXML', 'DISPID_SMSALineId', 'SDA_Two_Trailing_Spaces',
    'DISPID_SDKSetLongValue', 'Speech_Max_Pron_Length', 'SVEBookmark',
    'DISPID_SPRulesItem', 'DISPID_SLWs_NewEnum', 'DISPID_SOTSetId',
    'DISPID_SOTDisplayUI', 'SVP_1', 'SPCONTEXTSTATE',
    'SGRSTTTextBuffer', 'SRTAutopause', 'SPSHT_EMAIL',
    'SVSFlagsAsync', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPRuleFirstElement', 'SPGRAMMARWORDTYPE', 'SP_VISEME_13',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRsCommit', 'DISPID_SRState',
    'DISPID_SRGDictationLoad', 'SpMMAudioIn', 'DISPID_SOTId',
    'SPEI_SOUND_END', 'SP_VISEME_14', 'ISpeechRecoGrammar',
    'DISPID_SPRsCount', 'DISPID_SRRAudio', 'SRAInterpreter',
    'SpeechPropertyComplexResponseSpeed', 'SVP_10', 'SGDSActive',
    'ISpeechLexiconPronunciation', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpShortcut', 'SPINTERFERENCE_TOOFAST', 'SPAUDIOSTATUS',
    'SpeechTokenShellFolder', 'SPWORDPRONUNCIATION',
    'DISPID_SRStatus', 'SPSHT_OTHER', 'ISpeechFileStream',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_9',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SOTRemove',
    'DISPID_SLAddPronunciationByPhoneIds', 'STCRemoteServer',
    'SP_VISEME_5', 'ISpeechRecoResultTimes',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVEWord', 'SPEI_REQUEST_UI',
    'SBONone', 'DISPID_SWFEBitsPerSample', 'DISPID_SpeechRecoResult2',
    'SPSVerb', 'eLEXTYPE_PRIVATE14', 'ISpMMSysAudio',
    'SPEI_SOUND_START', 'SRTSMLTimeout',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPISaveToMemory',
    'SPCS_DISABLED', 'SVEAudioLevel', 'DISPID_SpeechRecoContext',
    'SRTReSent', 'SPSTREAMFORMATTYPE',
    'SpeechRegistryLocalMachineRoot', 'SpLexicon', 'SPEI_MAX_TTS',
    'SAFTCCITT_ALaw_22kHzMono', 'SPEI_PHRASE_START', 'SFTSREngine',
    'DISPID_SPEs_NewEnum', 'SDKLCurrentUser', 'DISPID_SRCEHypothesis',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRTLength', 'SVP_5',
    'SPPHRASEREPLACEMENT', 'DISPID_SGRSAddRuleTransition',
    'SpeechRunState', 'SAFTCCITT_uLaw_11kHzMono', 'SPWT_LEXICAL',
    'SP_VISEME_9', 'SAFT44kHz16BitMono', 'DISPID_SLWPronunciations',
    'DISPID_SPRuleName', 'SPRS_ACTIVE', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVEAudioLevel', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRuleConfidence', 'DISPID_SPRText',
    'SAFTADPCM_22kHzStereo', 'SGLexical', 'SP_VISEME_12',
    'ISpPhoneConverter', 'SPPS_RESERVED1', 'ISpLexicon',
    'WAVEFORMATEX', 'SPEI_TTS_PRIVATE', 'eLEXTYPE_MORPHOLOGY',
    'SVF_None', 'SPAS_RUN', 'SpeechCategoryVoices',
    'DISPID_SpeechLexicon', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechPhraseProperty', 'SVF_Emphasis', 'SPRST_NUM_STATES',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SABIEventBias',
    'SRADefaultToActive', 'ISpeechPhraseAlternates',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCRecognizer',
    'SAFTCCITT_ALaw_11kHzMono', 'eLEXTYPE_PRIVATE13',
    'DISPID_SGRsAdd', 'ISpGrammarBuilder', 'DISPID_SOTCategory',
    'DISPID_SpeechLexiconWords',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE9',
    'SREPrivate', 'SPSSuppressWord', 'DISPID_SMSADeviceId',
    'SPINTERFERENCE_NONE', 'ISpResourceManager', 'SpeechAudioState',
    'SpeechDictationTopicSpelling', 'DISPID_SPCIdToPhone',
    'DISPID_SpeechGrammarRule', 'ISpRecognizer',
    'SpeechBookmarkOptions', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SOTGetAttribute', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_MIN_TTS', 'DISPID_SDKSetStringValue', 'SPEI_END_SR_STREAM',
    'DISPID_SVSLastResult', 'SECFEmulateResult', 'SPPHRASE',
    'SREFalseRecognition', 'SITooFast', 'SpeechAllElements',
    'DISPID_SPRNumberOfElements', 'DISPID_SVRate',
    'SVSFParseAutodetect', 'DISPID_SpeechLexiconProns',
    'SAFT48kHz8BitMono', 'SECFNoSpecialChars', 'IEnumString',
    'DISPID_SRCEBookmark', 'SpeechTokenIdUserLexicon',
    'SpStreamFormatConverter', 'eLEXTYPE_RESERVED4',
    'SAFTGSM610_8kHzMono', 'SVP_18', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_PRIVATE2', 'SAFT11kHz16BitStereo',
    'DISPID_SVEEnginePrivate', 'SAFT22kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGetFormat',
    'SSSPTRelativeToEnd', 'ISpObjectWithToken',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpCustomStream',
    'DISPID_SGRSRule', 'SRESoundStart', 'DISPID_SGRInitialState',
    'SPWAVEFORMATTYPE', 'DISPID_SGRAddState', 'SVSFNLPMask',
    'STCLocalServer', 'SVEPhoneme', 'DISPID_SRRSetTextFeedback',
    'SPCT_SLEEP', 'DISPID_SDKEnumKeys', 'SP_VISEME_3',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SFSOpen', 'SVP_6',
    'DISPID_SLWLangId', 'SAFT32kHz16BitMono', 'SAFT16kHz8BitMono',
    'SAFTADPCM_8kHzStereo', 'SAFT12kHz16BitMono', 'DISPID_SPPsItem',
    'STSF_FlagCreate', 'ISpeechAudioBufferInfo',
    'DISPID_SGRs_NewEnum', 'IInternetSecurityManager', 'SVEAllEvents',
    'SVP_8', 'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechBaseStream',
    'DISPID_SGRSAddSpecialTransition', 'SDA_One_Trailing_Space',
    'SGSExclusive', 'SPSMF_UPS', 'DISPID_SLPsCount',
    'SpeechEngineProperties', 'SPEI_RECO_OTHER_CONTEXT', 'SVP_12',
    'SINone', 'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechGrammarRule',
    'SPEI_SR_PRIVATE', 'SAFT8kHz16BitMono',
    'DISPID_SPERetainedSizeBytes', 'SPLEXICONTYPE',
    'ISpeechPhraseInfoBuilder', 'SWPUnknownWordPronounceable',
    'SPINTERFERENCE', 'SPFM_CREATE', 'SVEPrivate',
    'DISPID_SRSClsidEngine', 'DISPID_SRRTTickCount',
    'DISPID_SOTGetStorageFileName', 'SP_VISEME_16',
    'DISPID_SPRFirstElement', 'DISPID_SAFType',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpResourceManager',
    'SpeechCategoryAppLexicons', 'SDA_No_Trailing_Space',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE18', 'SVP_0',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPRuleParent',
    'DISPID_SRRPhraseInfo', 'SPEI_WORD_BOUNDARY', 'ISpeechLexicon',
    'ISpeechGrammarRules', 'DISPID_SLPsItem', 'ISpRecoGrammar',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechLexiconPronunciation', 'ISpDataKey', 'SPWT_DISPLAY',
    'SpeechRuleAttributes', 'DISPID_SpeechGrammarRules',
    'DISPID_SLGenerationId', 'DISPID_SGRsItem', 'SVESentenceBoundary',
    'DISPID_SRGCmdSetRuleIdState', 'SPWORDPRONOUNCEABLE',
    'SAFT11kHz8BitStereo', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SMSGetData', 'SAFT24kHz8BitMono', 'SPAR_Unknown',
    'SPPS_Interjection', 'SPPS_SuppressWord',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTCCITT_uLaw_44kHzStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSHORTCUTPAIRLIST',
    'ISpRecognizer3', 'DISPID_SPEAudioTimeOffset', 'SPSLMA',
    'SPINTERFERENCE_NOSIGNAL', 'SPDATAKEYLOCATION', 'SP_VISEME_21',
    'SAFTDefault', 'SRAORetainAudio', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechAudio', 'DISPID_SRCRetainedAudio', 'SPVPRI_ALERT',
    'DISPID_SVEViseme', 'SAFT16kHz8BitStereo',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRSAddWordTransition',
    'SP_VISEME_8', 'SPINTERFERENCE_NOISE', 'DISPID_SRProfile',
    'DISPID_SVPriority', 'SPSERIALIZEDPHRASE', 'DISPID_SWFEExtraData',
    'ISpeechMemoryStream', 'DISPID_SpeechCustomStream',
    'SPXMLRESULTOPTIONS', 'DISPID_SRRTStreamTime', 'SITooLoud',
    'SPBO_PAUSE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechMMSysAudio', 'ISpXMLRecoResult', 'SVP_15',
    'DISPID_SWFEBlockAlign', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_RECO_STATE_CHANGE', 'SPFM_NUM_MODES', 'SREInterference',
    'SPEI_FALSE_RECOGNITION', 'SREStreamEnd', 'ISpeechPhraseRule',
    'DISPID_SPRDisplayAttributes', 'SVEStartInputStream',
    'ISpeechLexiconWords', 'ISpNotifySink', 'SPRECOCONTEXTSTATUS',
    'SRSEIsSpeaking', 'DISPID_SVSpeakStream', 'SPFM_OPEN_READWRITE',
    'SDA_Consume_Leading_Spaces', 'SpWaveFormatEx', 'SP_VISEME_7',
    'SASClosed', 'SPCT_SUB_COMMAND', 'DISPID_SVGetVoices',
    'SAFT16kHz16BitMono', 'SPWORDLIST', 'STSF_AppData', 'SBOPause',
    'SpeechMicTraining', 'SP_VISEME_6', 'DISPID_SPRsItem',
    'SAFT11kHz8BitMono', 'SECFDefault', 'DISPIDSPTSI',
    'DISPID_SVIsUISupported', 'SpeechCategoryAudioIn',
    'SpeechPropertyLowConfidenceThreshold', 'SPPS_RESERVED2',
    'DISPID_SpeechVoiceStatus', 'DISPID_SASCurrentDevicePosition',
    'SPWF_INPUT', 'SVSFParseSapi', 'DISPID_SRSetPropertyString',
    'SPAO_NONE', 'ISpStreamFormatConverter', 'ISpeechRecognizer',
    'DISPID_SPIAudioStreamPosition', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechPhraseRules', 'DISPID_SpeechPhraseElement',
    '__MIDL_IWinTypes_0009', 'SpFileStream',
    'SpeechRecoProfileProperties', 'Speech_StreamPos_RealTime',
    'DISPID_SGRsCount', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRCBookmark', 'DISPID_SRCPause', 'ISpNotifyTranslator',
    'ISpeechPhoneConverter', 'ISpeechRecoContext',
    'DISPID_SPIGetDisplayAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpeechAudioProperties',
    'DISPID_SRGCmdLoadFromMemory', 'SREHypothesis', 'IStream',
    'SpeechRuleState', 'DISPID_SVEBookmark',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIProperties',
    'SDTLexicalForm', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SASFreeBufferSpace', 'SSFMCreateForWrite',
    'DISPID_SLAddPronunciation', 'DISPID_SRDisplayUI',
    'DISPID_SGRSTPropertyId', 'SRERecognition',
    'DISPID_SPPConfidence', 'DISPID_SRRTimes', 'SPRST_ACTIVE',
    'SAFT44kHz8BitStereo', 'ISpeechWaveFormatEx',
    'DISPID_SpeechPhraseReplacement', 'SpeechVoiceCategoryTTSRate',
    'SPPS_Modifier', 'SECLowConfidence', 'DISPID_SRGCmdLoadFromFile',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVSLastBookmark',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPARecoResult',
    'DISPID_SPAs_NewEnum', 'SPPS_RESERVED4', 'SpeechCategoryAudioOut',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRs_NewEnum',
    'SPPS_LMA', 'SpPhraseInfoBuilder', 'DISPID_SLPLangId',
    'SAFT32kHz8BitStereo', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRCreateRecoContext', 'SPPS_RESERVED3',
    'STSF_CommonAppData', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPERetainedStreamOffset', 'SPRULESTATE', 'DISPID_SOTCId',
    'SPPS_NotOverriden', 'SPFM_OPEN_READONLY',
    'ISpeechPhraseReplacement', 'SPGRAMMARSTATE',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_17', 'SPSHORTCUTTYPE', 'DISPID_SRRSaveToMemory',
    'SpeechPropertyAdaptationOn', 'SPEI_MAX_SR', 'DISPID_SVSpeak',
    'SPAUDIOOPTIONS', 'ISpeechCustomStream', 'SAFT8kHz8BitStereo',
    'DISPID_SOTCDefault', 'SVEEndInputStream', 'eLEXTYPE_PRIVATE20',
    'SVP_4', 'SPSUnknown', 'SpeechDisplayAttributes',
    'DISPID_SGRSTNextState', 'DISPID_SOTCEnumerateTokens',
    'SPEVENTENUM', 'SpeechStreamSeekPositionType',
    'DISPID_SPPNumberOfElements', 'SpInprocRecognizer',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SpStream',
    'DISPID_SLWType', 'ISpeechObjectTokenCategory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpVoice',
    'eWORDTYPE_DELETED', 'SDKLDefaultLocation', 'STCInprocHandler',
    'SGSEnabled', 'DISPID_SpeechLexiconWord', 'SPDKL_LocalMachine',
    'SpSharedRecognizer', 'SpeechDataKeyLocation',
    'SRERecoOtherContext', 'SRAExport', 'SpeechWordType',
    'DISPID_SVSInputSentenceLength', 'ISpSerializeState',
    'DISPID_SLWsItem', 'DISPID_SPAStartElementInResult',
    'SGDSActiveUserDelimited', 'SVSFParseMask', 'SINoSignal',
    'SITooQuiet', 'DISPID_SVGetAudioOutputs', 'SpeechRecognitionType',
    'SPBINARYGRAMMAR', 'SDKLCurrentConfig', 'SPBO_TIME_UNITS',
    '_ISpeechRecoContextEvents', 'SPEI_RESERVED1',
    'SpObjectTokenCategory', 'DISPID_SRCERecognizerStateChange',
    'SPSMF_SAPI_PROPERTIES', 'SPEI_START_INPUT_STREAM',
    'SpMMAudioEnum', 'SPPS_Noncontent', 'DISPID_SVEVoiceChange',
    'SAFT44kHz8BitMono', 'SPEI_RESERVED3', 'DISPID_SPAsCount',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCESoundEnd',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_2',
    'DISPID_SOTCreateInstance', 'SRSInactiveWithPurge',
    'DISPID_SGRsFindRule', 'DISPID_SGRsCommitAndSave', 'SPBO_AHEAD',
    'ISpeechRecoResultDispatch', 'DISPID_SGRSTPropertyName',
    'DISPID_SABIBufferSize', 'SPAUDIOBUFFERINFO',
    'SREPropertyStringChange', 'DISPID_SVResume', 'SPEI_RESERVED2',
    'SP_VISEME_18', 'SVP_17', 'SAFT24kHz16BitMono',
    'DISPID_SPPFirstElement', 'DISPID_SGRSTsCount', 'DISPID_SVVolume',
    'DISPID_SRRSpeakAudio', 'DISPID_SDKEnumValues',
    'SAFTNoAssignedFormat', 'DISPID_SPIEngineId', 'DISPID_SRGId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SITooSlow',
    'SGPronounciation', 'SASPause', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCEEnginePrivate',
    'DISPIDSPTSI_SelectionLength', 'SVP_11',
    'DISPID_SPPEngineConfidence', 'SSTTTextBuffer',
    'ISpeechPhraseInfo', 'SAFTGSM610_11kHzMono', 'SpObjectToken',
    'SRAImport', 'DISPID_SRIsShared', 'SPEI_UNDEFINED',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SVSVisemeId',
    'DISPID_SRCEStartStream', 'ISpEventSource',
    'SpeechGrammarTagUnlimitedDictation', 'SFTInput',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVGetProfiles',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRGIsPronounceable',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVEPhoneme',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpRecoContext2',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVEStreamStart',
    'SP_VISEME_4', 'SRESoundEnd', 'SECNormalConfidence',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SMSSetData',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechVoiceEvent', 'SPAS_STOP',
    'SPCT_DICTATION', 'SAFT32kHz8BitMono', 'SPEI_RECOGNITION',
    'ISpeechXMLRecoResult', 'ISpeechLexiconWord',
    'DISPID_SRRTOffsetFromStart', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFT22kHz8BitStereo', 'DISPID_SGRSTType', 'SPAUDIOSTATE',
    'DISPID_SAStatus', 'SPAR_High', 'LONG_PTR', 'SLTUser',
    'SREStreamStart', 'DISPID_SVVoice', 'DISPID_SPCPhoneToId',
    'SAFTADPCM_8kHzMono', 'DISPID_SOTGetDescription', 'ISpProperties',
    'DISPID_SRAudioInput', 'SpMemoryStream', 'SP_VISEME_20',
    'SP_VISEME_15', 'SVP_7', 'DISPID_SAVolume', 'DISPID_SPIStartTime',
    'SPSModifier', 'SAFTText', 'DISPID_SCSBaseStream',
    'SAFT8kHz16BitStereo', 'SVSFDefault', 'DISPID_SPEPronunciation',
    'DISPID_SWFESamplesPerSec', 'SAFT22kHz16BitStereo',
    'DISPID_SGRSTText', 'eWORDTYPE_ADDED', 'DISPID_SpeechMMSysAudio',
    'DISPID_SGRSTsItem', 'DISPID_SPRuleEngineConfidence',
    'SAFT24kHz16BitStereo', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRGetPropertyString', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPEsCount', 'SPSEMANTICFORMAT', 'DISPID_SLWsCount',
    'SpeechGrammarWordType', 'SRSActiveAlways',
    'DISPID_SpeechPhraseProperties',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SDKDeleteValue',
    'DISPID_SRCState', 'DISPID_SRCCreateGrammar', 'SPVPRIORITY',
    'DISPID_SPRules_NewEnum', 'SDKLLocalMachine', 'SPEI_INTERFERENCE',
    'SpeechPropertyResponseSpeed', 'DISPID_SABIMinNotification',
    'SP_VISEME_19', 'DISPID_SGRName', 'SPGS_DISABLED',
    'DISPID_SRCRequestedUIType', 'SpeechRecoEvents',
    'SpSharedRecoContext', 'SPCT_COMMAND',
    'DISPID_SpeechRecognizerStatus', 'SpeechSpecialTransitionType',
    'SGRSTTWord', 'SPSFunction', 'DISPID_SVSpeakCompleteEvent',
    'SVEWordBoundary', 'DISPID_SpeechAudioFormat',
    'ISpeechRecoResult2', 'SpeechPropertyResourceUsage',
    'SpeechTokenKeyFiles', 'DISPID_SRGSetTextSelection',
    'DISPID_SPPs_NewEnum', 'SpeechVisemeFeature', 'SVP_13',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVEStreamEnd',
    'DISPID_SDKGetStringValue', 'DISPID_SPACommit', 'SVSFIsNotXML',
    'DISPID_SVSLastBookmarkId', 'SpeechCategoryPhoneConverters',
    'UINT_PTR', 'SDTAlternates', 'eLEXTYPE_APP',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTCSetId', 'SPEI_MIN_SR',
    'SpeechTokenKeyAttributes', 'DISPID_SRCEEndStream',
    'SpNotifyTranslator', 'SRARoot', 'DISPID_SRCEFalseRecognition',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechObjectTokens',
    'ISpeechPhraseReplacements', 'SVPNormal', 'DISPID_SpeechDataKey',
    'SVP_21', 'SpeechCategoryRecoProfiles',
    'SWPUnknownWordUnpronounceable', 'DISPID_SDKDeleteKey',
    'SpeechRecoContextState', 'ISpAudio', 'STSF_LocalAppData',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPIRetainedSizeBytes',
    'ISpPhoneticAlphabetConverter', 'SpeechGrammarState',
    'SGRSTTWildcard', 'SSSPTRelativeToStart', 'SVPOver',
    'ISpPhraseAlt', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_RESERVED6', 'SVP_20', 'SAFTGSM610_44kHzMono', 'SpVoice',
    'DISPID_SRCEAdaptation', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVSInputWordLength',
    'ISpeechGrammarRuleState', 'DISPID_SWFEFormatTag', 'SVP_16',
    '_SPAUDIOSTATE', 'SPBOOKMARKOPTIONS', 'DISPID_SABufferNotifySize',
    'DISPID_SOTsCount', 'SLTApp', 'DISPID_SRSAudioStatus',
    'SPRECORESULTTIMES', 'SpeechVoiceSpeakFlags', 'DISPID_SPPId',
    'SpMMAudioOut', 'DISPID_SRCESoundStart', 'DISPID_SPPValue',
    'DISPID_SLGetGenerationChange', 'SPEI_PHONEME',
    'SpeechUserTraining', 'SVSFIsXML', 'SPAO_RETAIN_AUDIO',
    'eLEXTYPE_PRIVATE10', 'SpNullPhoneConverter',
    'DISPID_SWFEChannels', 'SpeechDiscardType', 'SPGS_EXCLUSIVE',
    'ISpeechResourceLoader', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpTextSelectionInformation', 'SPSHT_NotOverriden',
    'ISpRecoResult', 'SPPHRASEELEMENT', 'DISPID_SLPSymbolic',
    'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE11', 'DISPID_SOTCGetDataKey',
    'SPVPRI_NORMAL', 'SpeechTokenValueCLSID',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechLexiconPronunciations', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCEPhraseStart', 'SVSFIsFilename', 'eLEXTYPE_PRIVATE3',
    'SPEI_RESERVED6', 'ISpeechAudioStatus',
    'DISPID_SRSCurrentStreamPosition', 'SpAudioFormat',
    'DISPID_SGRSTs_NewEnum', 'Speech_Default_Weight',
    'SAFTNonStandardFormat', 'SPEI_TTS_BOOKMARK', 'SINoise',
    'SRTEmulated', 'DISPID_SRCERecognitionForOtherContext',
    'SVPAlert', 'SAFTExtendedAudioFormat', 'STCInprocServer',
    'eLEXTYPE_PRIVATE17', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SGRSTransitions', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechXMLRecoResult', 'ISpeechPhraseElement',
    'DISPID_SDKGetBinaryValue', 'SPPS_Unknown', 'SDTAudio',
    'ISpeechPhraseAlternate', 'DISPID_SDKOpenKey', 'SGRSTTEpsilon',
    'SPSHT_Unknown', 'DISPID_SVWaitUntilDone', 'SPRST_ACTIVE_ALWAYS',
    'SRSEDone', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPELexicalForm', 'eLEXTYPE_RESERVED8', 'DISPID_SGRClear',
    'DISPID_SGRSTRule', 'DISPID_SRGReset', 'DISPID_SADefaultFormat',
    'DISPID_SpeechPhraseAlternate', 'DISPIDSPRG',
    'DISPID_SRCCmdMaxAlternates', 'Speech_StreamPos_Asap',
    'SREStateChange', 'DISPID_SPCLangId', 'SPVISEMES', 'SRSInactive',
    'eLEXTYPE_USER', 'SpeechAudioFormatType', 'eLEXTYPE_PRIVATE4',
    '_ISpeechVoiceEvents', 'DISPID_SRSetPropertyNumber',
    'SVSFUnusedFlags', 'DISPID_SABufferInfo',
    'DISPID_SpeechPhraseRule', 'DISPID_SVSInputSentencePosition',
    'SVSFVoiceMask', 'SLODynamic', 'SpeechWordPronounceable',
    'SAFT44kHz16BitStereo', 'SPSNoun', 'ISpStreamFormat',
    'SREPropertyNumChange', 'SSTTDictation', 'DISPID_SBSRead',
    'SPSNotOverriden', 'SpeechRecognizerState', 'SPAR_Low',
    'SPLO_DYNAMIC', 'SRADynamic', 'DISPID_SRGRules', 'ISpObjectToken',
    'DISPID_SRGDictationSetState',
    'SpeechPropertyHighConfidenceThreshold', 'SPDKL_DefaultLocation',
    'DISPID_SOTMatchesAttributes', 'SPXRO_SML',
    'SGLexicalNoSpecialChars', 'DISPID_SGRAttributes',
    'SPLOADOPTIONS', 'SGDSInactive', 'tagSPTEXTSELECTIONINFO',
    'SPRST_INACTIVE', 'SPAS_CLOSED', 'ISpPhrase', 'SRSActive',
    'eLEXTYPE_PRIVATE12', 'ISequentialStream', 'SAFT48kHz16BitStereo',
    'DISPID_SRCAudioInInterferenceStatus', '_RemotableHandle',
    'SpeechTokenContext', 'SAFTGSM610_22kHzMono', 'SVSFParseSsml',
    'SP_VISEME_10', 'DISPID_SDKCreateKey',
    'SAFTCCITT_ALaw_22kHzStereo', 'Speech_Max_Word_Length',
    'SGRSTTDictation', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_SR_RETAINEDAUDIO', 'SSFMOpenReadWrite',
    'DISPID_SRGDictationUnload', 'SPXRO_Alternates_SML',
    'SPEI_VISEME', 'SpeechStreamFileMode', 'SpeechGrammarTagWildcard',
    'SRERequestUI', 'ISpeechBaseStream', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRId', 'DISPID_SVEventInterests',
    'DISPID_SRSSupportedLanguages', 'SREBookmark', 'SPEI_RESERVED5',
    'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_2', 'SPDKL_CurrentConfig',
    'SECFIgnoreCase', 'DISPID_SPRuleChildren',
    ...
    'DISPID_SVPause', 'SPSHORTCUTPAIR', 'SSFMOpenForRead',
    'SpeechVoiceSkipTypeSentence', 'SpeechAddRemoveWord',
    'DISPID_SLGetWords', 'SPEI_START_SR_STREAM', 'SPPROPERTYINFO',
    'ISpeechPhraseProperties', 'SDTRule', 'DISPID_SOTsItem',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechObjectTokenCategory',
    'SECHighConfidence', 'SpeechAudioFormatGUIDText', 'SPEVENT',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRGetRecognizers', 'DISPID_SRCResume', 'SLOStatic',
    'SPGS_ENABLED', 'DISPIDSPTSI_ActiveLength', 'SVP_19',
    'IInternetSecurityMgrSite', 'DISPID_SRGRecoContext', 'SPBO_NONE',
    'SpPhoneConverter', 'SpeechLexiconType', 'SPVPRI_OVER', 'SVP_3',
    'SVEVoiceChange', 'SPPS_Function', 'STCAll', 'SREPhraseStart',
    'eLEXTYPE_RESERVED10', 'SAFTADPCM_22kHzMono',
    'DISPID_SAEventHandle', 'DISPID_SpeechMemoryStream',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVESentenceBoundary',
    'SpCompressedLexicon', 'SPAR_Medium',
    'ISpPhoneticAlphabetSelection', 'ISpObjectTokenCategory',
    'SPEI_END_INPUT_STREAM', 'SPWORDTYPE',
    'DISPID_SpeechGrammarRuleState', 'SPPHRASERULE',
    'SPWT_PRONUNCIATION', 'DISPID_SLWWord'
]

_check_version('1.2.0', 1700190363.960712)
